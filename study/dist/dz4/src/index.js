...
exports.observeChildNodes = exports.collectDOMStat = exports.deleteTextNodesRecursive = exports.deleteTextNodes = exports.findError = exports.findAllPSiblings = exports.prepend = exports.createAWithHref = exports.createDivWithText = undefined;
...
function findAllPSiblings(where) {
    ...
    try {
        for (var _iterator = (0, _getIterator3.default)(where.children), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
function findError(where) {
    ...
    try {
        for (var _iterator2 = (0, _getIterator3.default)(where.children), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
exports.createDivWithText = createDivWithText;
exports.createAWithHref = createAWithHref;
exports.prepend = prepend;
exports.findAllPSiblings = findAllPSiblings;
exports.findError = findError;
exports.deleteTextNodes = deleteTextNodes;
exports.deleteTextNodesRecursive = deleteTextNodesRecursive;
exports.collectDOMStat = collectDOMStat;
exports.observeChildNodes = observeChildNodes;
